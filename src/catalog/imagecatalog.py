...
class ImageCatalog:
    ...
    def __init__(self, image_catalog_name):
        self.satellite = None
        self.set_catalog(image_catalog_name)

    def set_catalog(self, image_catalog_name):
        self.satellite = self.catalog[image_catalog_name]

    def get_satellite(self):
        return self.satellite

    def get_collection_name(self):
        return self.satellite['collection_name']
